...
export type MarketingPhraseCanvasProps = {
  dateKey: string;
...
/** Vista 1080×1350 para frase del día (misma maqueta que /marketing/render/.../phrase). */
export function MarketingPhraseCanvas({
  dateKey,
  emotionalThemeIndex,
  financialThemeIndex,
  nutritionThemeIndex,
}: MarketingPhraseCanvasProps) {
